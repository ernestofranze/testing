...
namespace N5.Entities.Migrations.Migrations
{
    ...
    partial class EntityFrameworkSharedContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("N5.Administration.Filters.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("N5.Administration.Filters.RangeDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("DefinedRangeFilterId");
                    ...
                    b.HasIndex("DefinedRangeFilterId");

                    b.ToTable("RangeDefinitions");
                });
            ...
            modelBuilder.Entity("N5.Entities.Customer.CustomerKafkaMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CustomerKafkaMessage");
                });
            ...
            modelBuilder.Entity("N5.Administration.Filters.BooleanFilter", b =>
                {
                    b.HasBaseType("N5.Administration.Filters.Filter");


                    b.ToTable("BooleanFilter");

                    b.HasDiscriminator().HasValue("BooleanFilter");
                });

            modelBuilder.Entity("N5.Administration.Filters.BulkOptionsFilter", b =>
                {
                    b.HasBaseType("N5.Administration.Filters.Filter");


                    b.ToTable("BulkOptionsFilter");

                    b.HasDiscriminator().HasValue("BulkOptionsFilter");
                });

            modelBuilder.Entity("N5.Administration.Filters.DefinedRangeFilter", b =>
                {
                    b.HasBaseType("N5.Administration.Filters.Filter");


                    b.ToTable("DefinedRangeFilter");

                    b.HasDiscriminator().HasValue("DefinedRangeFilter");
                });

            modelBuilder.Entity("N5.Administration.Filters.FieldValueFilter", b =>
                {
                    b.HasBaseType("N5.Administration.Filters.Filter");


                    b.ToTable("FieldValueFilter");

                    b.HasDiscriminator().HasValue("FieldValueFilter");
                });

            modelBuilder.Entity("N5.Administration.Filters.OpenRangeFilter", b =>
                {
                    b.HasBaseType("N5.Administration.Filters.Filter");


                    b.ToTable("OpenRangeFilter");

                    b.HasDiscriminator().HasValue("OpenRangeFilter");
                });
            ...
            modelBuilder.Entity("N5.Administration.Filters.RangeDefinition", b =>
                {
                    b.HasOne("N5.Administration.Filters.DefinedRangeFilter", "DefinedRangeFilter")
                        .WithMany("RangeDefinitions")
                        .HasForeignKey("DefinedRangeFilterId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
